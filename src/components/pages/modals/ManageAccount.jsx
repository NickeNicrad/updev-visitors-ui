...
// 	const { fname, lname, email, phone, address } = user.result;
...
// 	const handleValue = (e) => {
// 		e.preventDefault();
// 		const { fname, lname, email, phone, address } = value.result;
...
// 								viewBox='0 0 24 24'
// 								stroke='currentColor'
// 								className='w-6 h-6 absolute bottom-0 right-6 bg-gray-100 rounded-full border-2 cursor-pointer hover:bg-gray-300 text-gray-600'>
// 								<path
// 									strokeLinecap='round'
// 									strokeLinejoin='round'
// 									strokeWidth='2'
